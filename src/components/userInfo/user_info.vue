...
<van-col span="14" ><van-field   @input="checkTels" placeholder="请输入被审核人员手机号" /></van-col>
</van-row>
<div v-show="showUserInfo" >
  <div class="demo-nav">
    ...
    <!-- <svg viewBox="0 0 1000 1000" class="demo-nav__back">
      ...
      <section class="van-doc-demo-section demo-count-down">
        ...
        <div class="van-doc-demo-block">
          ...
          <div class="van-count-down">{{ userinfo.sex==1?'男':'女'}}</div>
       </div>
          <div class="van-doc-demo-block">
            ...
            <div class="van-doc-demo-block">
              ...
              <div class="van-count-down">{{`${userinfo.FJsheng},${userinfo.FJshi},${userinfo.FJquxian}`}}</div>
              </div>
              <div class="van-doc-demo-block">
   ...
   <div class="van-doc-demo-block">
                  <h2 class="van-doc-demo-block__title">13、小区，楼栋，房间号</h2>
                  <div class="van-count-down">{{ userinfo.xiaoQu }}，{{ userinfo.louDong }}，{{ userinfo.fangHao }}</div>               
                  </div>
  ...
  <div class="van-doc-demo-block">
                  ...
                  <div class="van-count-down">{{ userinfo.D_class==1?'是':'否' }}</div>        
                   <div class="van-count-down">离开武汉时间：{{ userinfo.D_class_LkwhDate }}</div>          
                  </div>

  <div class="van-doc-demo-block">
                  <h2 class="van-doc-demo-block__title">18、湖北归来人员（A）</h2>
                  <div class="van-count-down">{{ userinfo.A_class==1?'是':'否' }}</div>        
                   <div class="van-count-down">离开湖北时间：{{ userinfo.D_class_LkwhDate }}</div>          
                  </div>
  <div class="van-doc-demo-block">
                  <h2 class="van-doc-demo-block__title">19、接触疫情情况（C）</h2>
                  <div class="van-count-down">{{ userinfo.C_class==1?'是':'否' }}</div>        
                   <div class="van-count-down">接触情况：{{ userinfo.C_class_jiechu_type }}</div>      
                       <div class="van-count-down">接触时间：{{ userinfo.C_class_jiechuDate }}</div>       
                  </div>

  <div class="van-doc-demo-block">
                  <h2 class="van-doc-demo-block__title">20、返/来邵前14天内是否已经居家/集中医学观察满14天（C）</h2>
                  <div class="van-count-down">{{ userinfo.LS_14_before==1?'是':'否' }}</div>        
                   
                           
                  </div>
  <div class="van-doc-demo-block">
                  <h2 class="van-doc-demo-block__title">21、有否发热情况(B)</h2>
                  <div class="van-count-down">{{ userinfo.B_class==1?'是':'否' }}</div>        
                   
                           
                  </div>
 <div class="van-doc-demo-block">
                  <h2 class="van-doc-demo-block__title">22、现在是否有其他症状（乏力、头疼、干咳、喉痛、鼻塞、流涕、寒战、气促、呼吸困难等）</h2>
                  <div class="van-count-down">{{ userinfo.isOK==1?'是':'否' }}</div>                             
                  </div>
                   <!-- <div class="van-doc-demo-block">
