...
import Vue from 'vue'
// fromUrl,
import { Tel ,ReportId,IsAdmin ,Version,AdminInfo,UserInfo,NodeID} from "@/store/mutation-types"//MD5Tel AdminInfo
 ...
 checkUserNamevalidator(val) {
  ...
  // checkCaptchatoken,
    ...
    async getSms() {
      ...
      setTimeout(() => {
        GetVerificatCodeAdSmssecret({contents:'输入验证码后即可进入大祥融媒统一线上报送平台，谢谢您的使用。可致电：0739-5396272多提宝贵意见', mobile: this.Report.tel }).then(res => {
