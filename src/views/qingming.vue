  ...
  <div class="qmsm">
    ...
    <van-row>
      <van-col style="padding:0px 5px 5px 5px;" span="24">
        <van-notice-bar
          text="温馨提醒:大祥区雨溪公墓实行按日分时段限流预约祭扫，可通过“云上清明”微信公众号或拨打电话0739-5300667预约或咨询。3月28日至４月12日，每个墓穴每天入园祭扫人员不超过３人，祭扫时间不超过１小时，未预约不得入园祭扫。"
          left-icon="volume-o"
        />
        <!-- <div style="border: 1px solid #129416;border-radius: 5px;">
        <p><b>温馨提醒：</b>您好，大祥区雨溪公墓清明节期间限流，需提前预约，否则可能耽误您的行程。</p>
      </div> -->
      </van-col>
    </van-row>
    <van-row>
        ...
        <van-tabs class="istabs" type="card" animated color="#129416">
          ...
          <van-tab class="selected">
            ...
            <van-row>
              <van-col span="24">
                <div class="myrow">
                  <a href="tel:0739-5300667"
                    >大祥区雨溪公墓电话：0739-5300667</a
                  >
                </div>
              </van-col>
            </van-row>
