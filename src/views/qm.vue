...
<header class="header-appClient">
                ...
                <a class="right-1" href="https://daxiang-wap.rednet.cn/app/index.html?contentId=6966421&contentType=1"></a>
        </header>
</van-col>
</van-row>
    <!-- <van-row>
...
<header class="header-text">
                ...
                <span class="left-3">目前已经有{{count}}位访客浏览</span>
...
/> -->
 ...
 <img alt="Vue logo" width="100%" src="../assets/777.jpg">
</van-col>
</van-row>
<van-row>
  <van-col style="padding:5px;border-radius:5px;" span="24">
...
<a href="https://h5.rednet.cn/c/b4xy/neph/index.html?t=0&amp;custom=&amp;crid=&amp;s=1" target="_self"><img width="100%" src="https://img.rednet.cn/2020/03-31/82ba4f1b-1b5e-47e1-b89b-4f0c2334040b.jpg" title="1.jpg" data-resourceid="694537454940250112" alt="1.jpg" _styleapp="width: 0px; height: 0px; "></a>
</van-col>
</van-row>
...
active:1
  ...
  methods: {
   async addCount()
    {
      console.log(1)
         let Randomnum=Math.random().toString().slice(-4);
         let rd=localStorage.getItem('rd')
         let res=''
         if(!rd)
         {
           res=await QMCount({rd:Randomnum})
           localStorage.setItem('rd',Randomnum) 
         }
         else
         {
           res=await QMCount({rd:rd})
         }
...
.right-1 {
	...
	height: 2.52rem;
	line-height: 0.82rem;
	background:url(//j.rednet.cn/site/static/images/btn_download.png) no-repeat;
