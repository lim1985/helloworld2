...
当前大祥区登记总数1000人（其中上：返邵来邵人员500人，本地居民500人），卡口50个，其中，重点跟踪的A类0人，B类20人，C类10人，D类13人，已取消观察0人。
    ...
    <van-row>
      <van-col span="24">
        <div class="text_1">
          14天内（即{{ Be15Dayafter }}以来）共登记{{
            Day15beforCountsdata.AllCount
          }}人，其中A类{{ Day15beforCountsdata.AclassCount }}人， B类{{
            Day15beforCountsdata.BclassCount
          }}人，C类{{ Day15beforCountsdata.CclassCount }}人，D类{{
            Day15beforCountsdata.DclassCount
          }}人。
          <!-- 目前，登记总数{{Countsdata.AllCount}}人(其中：返邵来邵人员{{Countsdata.FsPersonCount}}人，本地居民{{Countsdata.localPersonCount}}人)。 -->
        </div>
    ...
    <van-row>
     ...
     console.log(this.Be15Dayafter) -->
          ...
          }}人，C类{{ localtoDayCountsdata.CclassCount }}人， D类{{
            localtoDayCountsdata.DclassCount
          }}人。
          <!-- 目前，登记总数{{Countsdata.AllCount}}人(其中：返邵来邵人员{{Countsdata.FsPersonCount}}人，本地居民{{Countsdata.localPersonCount}}人)。 -->
        </div>
        <!-- toDayCountsdata:{ yesTeDayCountsdata:{Day15beforCountsdata -->
    ...
    <van-row>
      <van-col span="24">
        <div class="text_1">
          14天内（即{{ Be15Dayafter }}以来）共登记{{
            localDay15beforCountsdata.AllCount
          }}人，其中A类{{ localDay15beforCountsdata.AclassCount }}人， B类{{
            localDay15beforCountsdata.BclassCount
          }}人，C类{{ localDay15beforCountsdata.CclassCount }}人，D类{{
            localDay15beforCountsdata.DclassCount
          }}人。
          <!-- 目前，登记总数{{Countsdata.AllCount}}人(其中：返邵来邵人员{{Countsdata.FsPersonCount}}人，本地居民{{Countsdata.localPersonCount}}人)。 -->
        </div>
        <!-- toDayCountsdata:{ yesTeDayCountsdata:{Day15beforCountsdata -->
          ...
          <van-col span="24">
            <van-row class="lim_row2">
              <van-col span="11">
                <div class="title_3">
                  <span
                    >重点观察：<b>{{ Countsdata.ZDGZ_Count }}</b
                    >人</span
                  >
                </div>
              </van-col>
